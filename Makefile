...
SRC		= 	main.c \
			...
			utils/tokenization_utils.c \
			lexer/check_var.c \
			lexer/lexer_grammar.c \
			utils/token_lst_utils.c \
			expansion/var_expander.c \
			utils/var_expander_utils.c \
